    ...
    <div className="pt-24 pb-24 bg-dark-950">
      <Container>
        ...
        <div className="grid grid-cols-1 gap-12">
          {blogPosts.map((post) => (
            <article key={post.id} className="bg-dark-900 rounded-lg overflow-hidden group">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                ...
                <div className="p-8">
                  ...
                  <Link 
                    to={`/blog/${post.id}`}
                    className="inline-flex items-center text-primary-400 font-medium group-hover:underline"
                  >
